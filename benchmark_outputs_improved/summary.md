...
- Federated wins on communication and reported memory in the current 5-satellite setup: total MB 76.5 vs 236.7, peak memory KB 117.0 vs 505.0.
- Traditional is faster end-to-end: wall time 9.76s vs 57.66s.
...
- Traditional accuracy_1pct per second: 0.0427
- Federated accuracy_1pct per second: 0.0000
- Traditional R2 per second: 0.0908
- Federated R2 per second: 0.0014
