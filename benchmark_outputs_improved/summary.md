...
- Federated wins on communication and reported memory in the current 5-satellite setup: total MB 76.5 vs 236.7, peak memory KB 118.0 vs 501.9.
- Traditional is faster end-to-end: wall time 2.41s vs 76.54s.
...
- Traditional accuracy_1pct per second: 0.1731
- Federated accuracy_1pct per second: 0.0000
- Traditional R2 per second: 0.3681
- Federated R2 per second: 0.0010
